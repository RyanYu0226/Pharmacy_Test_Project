...
namespace T4U_Pharmacy_Web_API.Controllers
{
    public class MasksController : BaseController
    {
        ...
        public async Task<ActionResult<PharmacyMasksViewModel>> GetPharmacyMasksList([FromQuery][Required] long pharmacyId, [FromQuery][Required] string sortBy = "name", [FromQuery][Required] string sortOrder = "asc")
        {
